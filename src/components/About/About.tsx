      ...
      <section id="about">
        ...
        <div className=" flex flex-col gap-4">
          ...
          <p>
            ...
            encontrar o diseñar la joya perfecta para ti. Puedes visitarnos en
            nuestro local o agendar una cita para una consulta personalizada.
            Estamos comprometidos en hacer realidad tus sueños con la mejor
